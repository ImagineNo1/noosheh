...
export const storeApi = {
  ...
  paymentGateways: () => request<any[]>('/api/payments/gateways'),
  initiatePayment: (data: Record<string, any>) => request<any>('/api/payments/initiate', { method: 'POST', body: JSON.stringify(data) })
};
