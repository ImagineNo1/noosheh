...
export default function CategoryClient({
  ...
  const filtered = useMemo(() => {
    ...
    return list;
  }, [products, categorySlug, categoryTitle, collection, sort, priceRange]);
  ...
  return (
    <div className="store-page" dir="rtl">
      ...
      <div className="store-container store-page-body">
        <header className="store-category-seo-head">
          <h1>{title}</h1>
        ...
        <section className="store-category-copy">
          ...
          <p>برای انتخاب بهتر، مشخصات هر محصول، جنس، سایزهای موجود، رنگ‌ها و شرایط ارسال را در صفحه محصول بررسی کنید. لینک‌های دسته‌بندی بالا به گوگل و کاربران کمک می‌کند سریع‌تر بین کالکشن‌های نوشه حرکت کنند.</p>
          <div>
