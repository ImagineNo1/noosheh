...
export default function OrderDetailsPage() {
  ...
  useEffect(() => {
    ...
    accountApi
      .orders()
      .then((orders) => setOrder(orders.find((item) => item.id === paramId) || null))
