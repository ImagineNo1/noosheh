export type AdminEntity = 'Product' | 'Order' | 'Category' | 'SiteSettings' | 'Review' | 'Address' | 'CartItem' | 'ReturnRequest' | 'Wishlist' | 'PaymentGateway' | 'PaymentTransaction' | 'ProductAttribute' | 'SeoSettings' | 'SeoMeta' | 'Redirect' | 'NotFoundLog' | 'BlogPost' | 'BlogCategory';
